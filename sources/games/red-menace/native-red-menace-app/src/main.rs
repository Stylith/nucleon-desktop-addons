...
use robcos_native_red_menace_app::{input_from_ctx, RedMenaceConfig, RedMenaceGame};
use std::time::Instant;

const APP_ICON_BYTES: &[u8] = include_bytes!("../../../icon.png");
const APP_TITLE: &str = "Red Menace";
const DEFAULT_WINDOW_SIZE: [f32; 2] = [1180.0, 920.0];
const MIN_WINDOW_SIZE: [f32; 2] = [760.0, 620.0];

struct RedMenaceStandaloneApp {
    game: RedMenaceGame,
    last_frame: Instant,
}

impl RedMenaceStandaloneApp {
    fn new() -> Self {
        Self {
...
impl App for RedMenaceStandaloneApp {
...
fn main() -> Result<()> {
    ...
    eframe::run_native(
        ...
        Box::new(|cc| {
            ...
            Ok(Box::new(RedMenaceStandaloneApp::new()))
        }),
    )
